...
const Essence = () => {
  const { products, getProducts, categoryEssence, skin } = useProducts();
  ...
  const catEssence = categoryEssence();
  ...
  const count = Math.ceil(catEssence?.length / itemsPerPage); // общее кол-во страниц пагинации
  ...
  function currentData() {
    ...
    return catEssence.slice(begin, end);
  }
