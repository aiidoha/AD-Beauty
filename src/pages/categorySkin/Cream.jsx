...
const Cream = () => {
  const { products, getProducts, categoryCream, skin } = useProducts();
  ...
  const count = Math.ceil(catCream?.length / itemsPerPage); // общее кол-во страниц пагинации
  ...
  function currentData() {
    ...
    return catCream.slice(begin, end);
  }
