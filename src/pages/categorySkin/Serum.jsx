...
const Serum = () => {
  const { products, getProducts, categorySerum, skin } = useProducts();
  ...
  const count = Math.ceil(catSerum?.length / itemsPerPage); // общее кол-во страниц пагинации
  ...
  function currentData() {
    ...
    return catSerum.slice(begin, end);
  }
